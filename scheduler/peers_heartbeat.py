...
# Target 3h between rounds. The peer default timeout is 12h
# (installer failsafe_engine.py DEFAULT_TIMEOUT_SECONDS = 43200), so ~4 rounds
# fit in one timeout window and a missed round is harmless.
HEARTBEAT_INTERVAL = int(os.getenv("HEARTBEAT_INTERVAL_SECONDS", "10800"))
